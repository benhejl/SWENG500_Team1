<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditForumPost.aspx.cs" Inherits="ProjectManagerWeb.Forum.EditForumPost" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td style="text-align:center;">
                <asp:TextBox ID="txtBoxSubject" runat="server" ReadOnly="true" Width="800px" ></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align:left;">
